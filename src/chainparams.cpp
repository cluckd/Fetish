...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("45.55.168.225", "188.226.162.76"));
        vSeeds.push_back(CDNSSeedData("178.62.150.165", "108.61.10.90"));
        vSeeds.push_back(CDNSSeedData("199.68.198.33", "91.121.165.120"));
        vSeeds.push_back(CDNSSeedData("209.188.31.47", "104.28.21.109"));
        vSeeds.push_back(CDNSSeedData("188.180.62.185", "94.23.32.109"));
